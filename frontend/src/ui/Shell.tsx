  ...
  return (
    <div className="modulePage geomotionLaunchPage">
      <ModuleHero
        ...
        title="GeoMotion 3D"
        description="GeoMotion opens separately so the active blasting bench, firing sequence and predicted movement envelope can use the full browser viewport without the application sidebar."
      >
      ...
      <section className="card geomotionLaunchCard">
        ...
        <div>
          <div className="sectionTitle">Focused active-bench movement</div>
          <p className="subtitle">
            The dedicated view shows only the bench being blasted: real tie-up coordinates,
            the modelled rock footprint, free-face direction, delay playback and the predicted
            bulk-movement envelope. Sign-in remains required when authentication is enabled.
          </p>
        </div>
        <button
